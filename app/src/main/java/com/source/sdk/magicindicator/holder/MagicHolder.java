package com.source.sdk.magicindicator.holder;
...
import com.source.sdk.magicindicator.adapter.ExamplePagerAdapter;
import com.source.sdk.magicindicator.widget.ScaleTransitionPagerTitleView;
import com.source.sdk.widget.magicindicator.MagicIndicator;
import com.source.sdk.widget.magicindicator.ViewPagerHelper;
import com.source.sdk.widget.magicindicator.buildins.UIUtil;
import com.source.sdk.widget.magicindicator.buildins.commonnavigator.CommonNavigator;
import com.source.sdk.widget.magicindicator.buildins.commonnavigator.abs.CommonNavigatorAdapter;
import com.source.sdk.widget.magicindicator.buildins.commonnavigator.abs.IPagerIndicator;
import com.source.sdk.widget.magicindicator.buildins.commonnavigator.abs.IPagerTitleView;
import com.source.sdk.widget.magicindicator.buildins.commonnavigator.indicators.LinePagerIndicator;
import com.source.sdk.widget.magicindicator.buildins.commonnavigator.titles.ClipPagerTitleView;
import com.source.sdk.widget.magicindicator.buildins.commonnavigator.titles.ColorTransitionPagerTitleView;
import com.source.sdk.widget.magicindicator.buildins.commonnavigator.titles.SimplePagerTitleView;
import com.source.sdk.widget.magicindicator.buildins.commonnavigator.titles.badge.BadgeAnchor;
import com.source.sdk.widget.magicindicator.buildins.commonnavigator.titles.badge.BadgePagerTitleView;
import com.source.sdk.widget.magicindicator.buildins.commonnavigator.titles.badge.BadgeRule;
...
public class MagicHolder extends BaseSubscriberHolder<Object>{
    ...
    public MagicHolder(View contentView, IHolderManager manager) {
    ...
    private void initMagicIndicator3() {
        ...
        commonNavigator.setAdapter(new CommonNavigatorAdapter() {
            ...
            public IPagerIndicator getIndicator(Context context) {
                LinePagerIndicator indicator = new LinePagerIndicator(context);
                float navigatorHeight = context.getResources().getDimension(R.dimen.widget_dp_45);
